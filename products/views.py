...
def displayProductDetails(request, product_id):
    try:
        ...
        cursor1.execute(
            """select avg(Review) ,count(Review) from user_reviews where Review=1 and product_id= %s""",
            [product_id],
        )
        ...
        cursor2.execute(
            """select avg(Review) ,count(Review) from user_reviews where Review=2 and product_id= %s""",
            [product_id],
        )
        ...
        cursor3.execute(
            """select avg(Review) ,count(Review) from user_reviews where Review=3 and product_id= %s""",
            [product_id],
        )
        ...
        cursor4.execute(
            """select avg(Review) ,count(Review)from user_reviews where Review=4 and product_id= %s""",
            [product_id],
        )
        ...
        cursor5.execute(
            """select avg(Review) ,count(Review) from user_reviews where Review=5 and product_id= %s""",
            [product_id],
        )
