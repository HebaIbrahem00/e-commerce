...
urlpatterns = [
    ...
    # ex: /products/
    path('/products', views.display_home_page, name='displayAllProducts'),
    # ex: /products/5/
    ...
    path('ajax/get_all_cat_details', views.get_all_cat_details, name='get_all_cat_details'),
    path('addtocart', views.addToCart, name='get_all_cat_details')]